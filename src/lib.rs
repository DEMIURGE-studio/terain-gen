...
use crate::perlin::{init_perlin_pipeline, prepare_bind_group, NoiseImageOutput, NoiseShaderSettings, PerlinNoiseNode};
...
impl Plugin for TerrainPlugin {
    fn build(&self, app: &mut App) {
        ...
        render_app
            ...
            .add_systems(
                Render,
                prepare_bind_group.in_set(bevy::render::RenderSet::PrepareBindGroups),
            );
